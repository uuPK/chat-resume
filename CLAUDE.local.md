...
**YOU ARE IN: `chat_resume/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/chat_resume/` (rig root) or other directories
...
**Your mail address:** `chat_resume/polecats/furiosa`
**Your rig:** chat_resume
**Your Witness:** `chat_resume/witness`
...
| Ask Witness for help | `gt mail send chat_resume/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`chat_resume/witness`) when:
...
```bash
gt mail send chat_resume/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
