...
export default function InterviewReportPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/resume/${resumeId}/edit?agent=interview&from_report=${reportId}`)
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-md rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm text-gray-600">
          旧报告链路已下线，请回到简历编辑页使用“面试 AGENT”。
        </p>
        <Link
          href={resumeId ? `/resume/${resumeId}/edit?agent=interview` : '/dashboard'}
