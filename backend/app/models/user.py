...
from sqlalchemy import Boolean, DateTime, ForeignKey, String, UniqueConstraint, JSON
...
class User(Base):
    ...
    role: Mapped[str] = mapped_column(String, default="candidate", server_default="candidate")
